...
public protocol AccountSessionStore {
    /// 更新账户
    @discardableResult
...
public protocol AccountUserStore {
    /// 更新用户信息
    @discardableResult
...
public protocol AccountRemoteService {
    /// 获取用户信息
...
public protocol AccountRouteService {
    /// 打开修改密码页面
    func toUpdatePassword(from: UIViewController)
}

public protocol AccountProtocol: AccountSessionStore, AccountUserStore, AccountRemoteService, AccountRouteService {
}
